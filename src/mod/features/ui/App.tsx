...
const IS_DEV = false;
const GITHUB_REPO_URL = "https://github.com/Slesari690/YandexMusicBetaMod/";
  ...
  const appMetaQuery = useQuery({
    ...
    queryFn: async () => {
      const data = await fetch(
        "https://raw.githubusercontent.com/Slesari690/YandexMusicBetaMod/refs/heads/main/.meta/meta.json",
      );
      if (data.status !== 200) {
